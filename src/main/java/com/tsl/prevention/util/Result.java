...
public class Result<T> implements Serializable {
    ...
    public Result( Integer code, String message, String requestId) {
        setSuccess(false);
        setCode(code);
        setMessage(message);
        setRequestId(requestId);
    ...
    public Result(boolean isSuccess, Integer code, String message, T t) {
        setSuccess(isSuccess);
        setCode(code);
        setMessage(message);
        setData(t);
     ...
     * @return
     */
    public static <T> Result<T> create(T data, Integer code, String message) {
        Result<T> result = Result.create();
        result.setSuccess(true);
        result.setData(data);
        result.setCode(code);
     ...
     * @return
     */
    public static <T> Result<T> create(T data, Integer code, String message, String requestId, String dynamicCode,
     ...
     * @return
     */
    public static <T> Result<T> create(T data, Integer code, String message, String requestId) {
        Result<T> result = Result.create();
        result.setSuccess(true);
        result.setData(data);
        result.setCode(code);
     ...
     * @return Result<T>
     */
    public static <T> Result<T> create(Integer code, String message, String requestId) {
        Result<T> result = Result.create();
        result.setSuccess(false);
        result.setCode(code);
        result.setMessage(message);
     ...
     * @return Result<T>
     */
    public static <T> Result<T> create(Integer code, String message, String requestId, String dynamicMessage) {
        Result<T> result = Result.create();
        result.setSuccess(false);
        result.setCode(code);
        result.setMessage(message);
